 ...
 */
import { MAJORS, LANES, lookup, render, terms, orgSearch, renderOrgs, startItems, hackathonsNyc, renderHacks } from "./worker.js";
...
export default {
  async fetch(request, env, ctx) {
    ...
    const lane = LANES[o.lane] || ["orgs", "start", "hackathons"].includes(o.lane) ? o.lane : "build";
